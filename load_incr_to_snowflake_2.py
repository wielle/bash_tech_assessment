...
# df['close_approach_data'] = pd.to_datetime(df['close_approach_data'], errors='coerce')
...
# # Extract the maximum date from the DataFrame and convert it to the correct format
# max_date = df['close_approach_data'].max().date()
